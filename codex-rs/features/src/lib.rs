...
pub enum Feature {
    ...
    ApplyPatchFreeform,
    /// Expose selected turn environments to the model and allow tools to target them by id.
    MultiEnvironmentTools,
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        id: Feature::MultiEnvironmentTools,
        key: "multi_environment_tools",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
